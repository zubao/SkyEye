...
class SkyEyeAnalyticsDefaultMethodVisitor extends AdviceAdapter {

    String methodName

    SkyEyeAnalyticsDefaultMethodVisitor(MethodVisitor mv, int access, String name, String desc) {
        super(SkyEyeAnalyticsUtil.ASM_VERSION, mv, access, name, desc)
        methodName = name
        if (Logger.debug) {

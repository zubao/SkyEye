...
class SkyEyeAnalyticsPlugin implements Plugin<Project> {
    @Override
    void apply(Project project) {
        Instantiator ins = ((DefaultGradle) project.getGradle()).getServices().get(Instantiator)
        def args = [ins] as Object[]
        SkyEyeAnalyticsExtension extension = project.extensions.create("sensorsAnalytics", SkyEyeAnalyticsExtension, args)
        ...
        if (!disableSensorsAnalyticsPlugin) {
            ...
            SkyEyeAnalyticsTransformHelper transformHelper = new SkyEyeAnalyticsTransformHelper(extension)
            ...
            appExtension.registerTransform(new SkyEyeAnalyticsTransform(transformHelper))

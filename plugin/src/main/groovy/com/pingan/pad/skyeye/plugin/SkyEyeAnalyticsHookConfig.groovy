...
class SkyEyeAnalyticsHookConfig {
    public static final String SENSORS_ANALYTICS_API = "com/pingan/pad/skyeye/data/SkyEyeAutoTraceAPI"
    public final static HashMap<String, SkyEyeAnalyticsMethodCell> INTERFACE_METHODS = new HashMap<>()

    static {
        addInterfaceMethod(new SkyEyeAnalyticsMethodCell(
                'onCheckedChanged',
    ...
    static void addInterfaceMethod(SkyEyeAnalyticsMethodCell sensorsAnalyticsMethodCell) {
     ...
     * Fragment中的方法
     */
    public final static HashMap<String, SkyEyeAnalyticsMethodCell> FRAGMENT_METHODS = new HashMap<>()

    static {
        FRAGMENT_METHODS.put('onResume()V', new SkyEyeAnalyticsMethodCell(
                'onResume',
                '()V',
                ...
                0, 1,
                [Opcodes.ALOAD]))
        FRAGMENT_METHODS.put('setUserVisibleHint(Z)V', new SkyEyeAnalyticsMethodCell(
                'setUserVisibleHint',
                '(Z)V',
                '',// parent省略，均为 android/app/Fragment 或 android/support/v4/app/Fragment
                ...
                0, 2,
                [Opcodes.ALOAD, Opcodes.ILOAD]))
        FRAGMENT_METHODS.put('onHiddenChanged(Z)V', new SkyEyeAnalyticsMethodCell(
                'onHiddenChanged',
                '(Z)V',
                '',
                ...
                0, 2,
                [Opcodes.ALOAD, Opcodes.ILOAD]))
        FRAGMENT_METHODS.put('onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V', new SkyEyeAnalyticsMethodCell(
                'onViewCreated',
    ...
    public final static HashMap<String, SkyEyeAnalyticsMethodCell> LAMBDA_METHODS = new HashMap<>()
    static {
        addLambdaMethod(new SkyEyeAnalyticsMethodCell(
                'onClick',
                '(Landroid/view/View;)V',
    ...
    static void addLambdaMethod(SkyEyeAnalyticsMethodCell sensorsAnalyticsMethodCell) {
        if (sensorsAnalyticsMethodCell != null) {

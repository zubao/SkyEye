...
class SkyEyeAnalyticsTransform extends Transform {
    private SkyEyeAnalyticsTransformHelper transformHelper
    public static final String VERSION = "1.0.0"
    public static final String MIN_SDK_VERSION = "1.5.1"
    private WaitableExecutor waitableExecutor

    SkyEyeAnalyticsTransform(SkyEyeAnalyticsTransformHelper transformHelper) {
    ...
    void transformJar(File dest, JarInput jarInput, Context context) {
        ...
        if (!transformHelper.extension.disableJar || jarInput.file.absolutePath.contains('PAD')) {
    ...
    private byte[] modifyClass(byte[] srcClass, ClassNameAnalytics classNameAnalytics) {
        try {
            ...
            ClassVisitor classVisitor = new SkyEyeAnalyticsClassVisitor(classWriter, classNameAnalytics, transformHelper)

...
class SkyEyeAnalyticsTransformHelper {

    SkyEyeAnalyticsExtension extension
    SkyEyeAnalyticsSDKHookConfig sensorsAnalyticsHookConfig
    boolean disableSensorsAnalyticsMultiThread
    boolean disableSensorsAnalyticsIncremental
    boolean isHookOnMethodEnter
    HashSet<String> exclude = ['com.pingan.pad.skyeye', 'android.support', 'androidx', 'com.qiyukf', 'android.arch', 'com.google.android']
    ...
    SkyEyeAnalyticsTransformHelper(SkyEyeAnalyticsExtension extension) {
    ...
    private void createSensorsAnalyticsHookConfig() {
        sensorsAnalyticsHookConfig = new SkyEyeAnalyticsSDKHookConfig()
        List<MetaProperty> metaProperties = SkyEyeAnalyticsSDKExtension.getMetaClass().properties
